...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------+--------+--------|
      _______, _______, _______, _______, _______, _______, KC_HOME, KC_END ,     _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MUTE, _______,
  //|--------+--------+--------+--------+---+----+---+----+--------+--------|   |--------+--------+-----+--+-----+--+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------.                     ,--------+--------+--------+--------+--------+--------+--------|
      _______, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, KC_WH_U,                       KC_WH_U, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______,  KC_F12,
  //|--------+--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------+--------|
      _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_WH_D,                       KC_WH_D, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------+--------+--------|
      _______, _______, _______, _______, _______, _______, _______, _______,     KC_HOME,  KC_END, _______, _______, KC_MPRV, KC_MNXT, KC_MUTE, _______,
  //|--------+--------+--------+--------+---+----+---+----+--------+--------|   |--------+--------+-----+--+-----+--+--------+--------+--------+--------|
      _______, _______, _______, _______,     _______,      _______, _______,     _______, _______,       _______,    KC_MPRV, KC_VOLD, KC_VOLU, KC_MPLY
  //`--------+--------+--------+--------+   +--------+    +--------+--------/   \--------+--------+     +--------+  +--------+--------+--------+--------'
),
