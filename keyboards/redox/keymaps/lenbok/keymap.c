...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] = LAYOUT(
  //,--------+--------+--------+--------+--------+--------.                                       ,--------+--------+--------+--------+--------+--------.
      DEBUG  , EEP_RST, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______, _______, \
  //|--------+--------+--------+--------+--------+--------+--------.                     ,--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+---+----+---+----+--------+--------|   |--------+--------+-----+--+-----+--+--------+--------+--------+--------|
      VLK_TOG, _______, _______, _______,     _______,      _______, _______,     _______, _______,       _______,    _______, _______, _______, _______ \
  //`--------+--------+--------+--------+   +--------+    +--------+--------/   \--------+--------+     +--------+  +--------+--------+--------+--------'
  )
