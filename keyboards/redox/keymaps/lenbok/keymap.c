...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.             ,----+----+----+----+----+----+----.
     GRV,  1  , 2  , 3  , 4  , 5  ,ESC ,              MINS, 6  , 7  , 8  , 9  , 0  ,BSPC,
  //|----+----+----+----+----+----+----|             |----+----+----+----+----+----+----|
     TAB , Q  , W  , E  , R  , T  ,INS ,              EQL , Y  , U  , I  , O  , P  ,BSLS,
  //|----+----+----+----+----+----+ \----\         /----/ +----+----+----+----+----+----|
     LCTL, A  , S  , D  , F  , G  ,  PGUP,          RBRC,   H  , J  , K  , L  ,SCLN,QUOT,
  //|----+----+----+----+----+----+  \----\       /----/  +----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  ,    PGDN,      LBRC    , N  , M  ,COMM,DOT ,SLSH,RSFT,
  //|----+----+----+----+----+---/----/----/      \----\---\---+----+----+----+----+----|
     LOWR,RASE,LGUI,RGUI,  LALT  ,ENT ,LOWR,       RASE,SPC ,  RALT ,LEFT,DOWN, UP ,RGHT
  //`----+----+----+----+/----/ /----/----/        \----\----\ \---\+----+----+----+----'
  ),
